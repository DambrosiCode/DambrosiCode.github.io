...
```
![Unique word to length ratio, averaged every year]({{site.url}}{{site.baseurl}}/images/Country Lyrics/percent unique country.png)

And lo and behold, when averaging over the yearly data, there is a clear trend. Not too dramatic (about a .05% decrease every year), but it's still something, and there is more data to be scrounged.
...
```
![Unique word to length ratio, averaged every year]({{site.url}}{{site.baseurl}}/images/Country Lyrics/Aver sentiment.png)
...
```
![Unique word to length ratio, averaged every year]({{site.url}}{{site.baseurl}}/images/Country Lyrics/Word Use All.png)
...
![Unique word to length ratio, averaged every year]({{site.url}}{{site.baseurl}}/images/Country Lyrics/Word Use God.png)
